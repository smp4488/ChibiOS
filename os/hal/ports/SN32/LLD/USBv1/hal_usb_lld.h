 ...
 */
#if !defined(SN32_USB_LOW_POWER_ON_SUSPEND) || defined(__DOXYGEN__)
#define SN32_USB_LOW_POWER_ON_SUSPEND      FALSE
#endif

/**
 * @brief   USB1 interrupt priority level setting.
 */
#if (!defined(SN32_USB_USB1_HP_IRQ_PRIORITY) &&                           \
     (SN32_USB1_HP_NUMBER != SN32_USB1_LP_NUMBER)) || defined(__DOXYGEN__)
#define SN32_USB_USB1_HP_IRQ_PRIORITY      13
#endif

/**
 * @brief   USB1 interrupt priority level setting.
 */
#if !defined(SN32_USB_USB1_LP_IRQ_PRIORITY) || defined(__DOXYGEN__)
#define SN32_USB_USB1_LP_IRQ_PRIORITY      14
#endif
 ...
 */
#if !defined(SN32_USB_USE_ISOCHRONOUS) || defined(__DOXYGEN__)
#define SN32_USB_USE_ISOCHRONOUS           FALSE
#endif
...
#if SN32_USB_USE_USB1 &&                                                   \
    (SN32_USB1_HP_NUMBER != SN32_USB1_LP_NUMBER) &&                       \
    !OSAL_IRQ_IS_VALID_PRIORITY(SN32_USB_USB1_HP_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to USB HP"
#endif

#if SN32_USB_USE_USB1 &&                                                   \
    !OSAL_IRQ_IS_VALID_PRIORITY(SN32_USB_USB1_LP_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to USB LP"
#endif

#if SN32_USBCLK != 48000000
#error "the USB driver requires a 48MHz clock"
#endif

#if !defined(SN32_USB1_HP_HANDLER)
#error "SN32_USB1_HP_HANDLER not defined"
#endif

#if !defined(SN32_USB1_HP_NUMBER)
#error "SN32_USB1_HP_NUMBER not defined"
#endif

#if !defined(SN32_USB1_LP_HANDLER)
#error "SN32_USB1_LP_HANDLER not defined"
#endif

#if !defined(SN32_USB1_LP_NUMBER)
#error "SN32_USB1_LP_NUMBER not defined"
#endif
 ...
 * @notapi
 */
#define usb_lld_get_frame_number(usbp) (SN32_USB->FNR & FNR_FN_MASK)
...
#if SN32_USB_HAS_BCDR || defined(__DOXYGEN__)
/**
...
#define usb_lld_connect_bus(usbp) (SN32_USB->BCDR |= USB_BCDR_DPPU)
#endif
...
#define usb_lld_disconnect_bus(usbp) (SN32_USB->BCDR &= ~USB_BCDR_DPPU)
#endif
#endif /* SN32_USB_HAS_BCDR */
