 ...
 * @note    This file requires definitions from the ST SN32 header files
 *          sn32f10x.h or sn32l1xx.h.
 *
 * @addtogroup USB
 * @{
 */
 ...
 */
#if SN32_USB_ACCESS_SCHEME_2x16
...
#define SN32_USB_BASE          USB_BASE
#else
#define SN32_USB_BASE          (APB1PERIPH_BASE + 0x5C00)
#endif
...
#define SN32_USBRAM_BASE       USB_PMAADDR
#else
#define SN32_USBRAM_BASE       (APB1PERIPH_BASE + 0x6000)
#endif
